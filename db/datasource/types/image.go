...
func (r *RoundRecordImage) AppendBeforeImages(images []*RecordImage) {
	for _, image := range images {
		r.AppendBeforeImage(image)
	}
}

// AppendBeforeImage
func (r *RoundRecordImage) AppendBeforeImage(image *RecordImage) {
	r.bIndex++
...
func (r *RoundRecordImage) BeforeImages() RecordImages {
	return r.before
}
